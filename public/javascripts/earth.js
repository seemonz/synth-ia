...
if (visualBg === "earth"){
  ...
  $(function(){ 
    $(function () {
        $('#second-frame').append("<div id='earth-frame'></div>")
        var Mountain, MountainRange, dt, mountainRanges, sketch;
        sketch = Sketch.create({container: document.getElementById('earth-frame')});
        ...
        MountainRange.prototype.render = function () {
            ...
            sketch.translate(this.x , (sketch.height - 400) / 20 * this.layer);
            sketch.beginPath();
