...
if (visualBg === "night"){
  $(function(){
    ...
    $('#second-frame').append("<div id='night-frame'></div>");
    $('#night-frame').append("<canvas id='bgCanvas'></canvas>");

    // Terrain stuff.
    var background = document.getElementById("bgCanvas");
    var bgCtx = background.getContext("2d");

    var width = document.getElementById('second-frame').clientWidth;
    var height = document.getElementById('second-frame').clientHeight;
    ...
    function Terrain(options) {
        ...
        div = document.getElementById('night-frame')
        div.appendChild(this.terrain)
    }
